...
class CometEnvironment(DefaultSlurmEnvironment):
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument(
            '--memory',
            help="Specify how much memory to reserve per node. Only relevant for shared queue jobs.")

        parser.add_argument(
            '--job-output',
            help='What to name the job output file. If omitted, uses the system default (slurm default is "slurm-\%j.out").')
