...
class _Hooks:
    ...
    on_success : list of callables
        Function(s) to execute after the operation exits without an error.
    on_error : list of callables
    ...
    def __init__(self, *, on_start=None, on_exit=None, on_success=None, on_error=None):
        ...
        set_hooks(self, "on_finish", on_exit)
        set_hooks(self, "on_success", on_success)
        set_hooks(self, "on_fail", on_error)
